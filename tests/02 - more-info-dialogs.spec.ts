...
test('Option: hide_dialog_header_breadcrumb_navigation', async ({ page }) => {
	...
	await expect(page.locator(DIALOGS_SELECTORS.BREADCRUMB_NAVIGATION)).toBeVisible();

	await turnBooleanState(page, ENTITIES.HIDE_DIALOG_HEADER_BREADCRUMB_NAVIGATION, true);

	await expect(page.locator(DIALOGS_SELECTORS.BREADCRUMB_NAVIGATION)).toBeHidden();
	await expect(page).toHaveScreenshot('01-hide_dialog_header_breadcrumb_navigation.png');

	await turnBooleanState(page, ENTITIES.HIDE_DIALOG_HEADER_BREADCRUMB_NAVIGATION, false);
...
test('Option: hide_dialog_header_history', async ({ page }) => {
	...
	await expect(page).toHaveScreenshot('02-hide_dialog_header_history.png');
...
test('Option: hide_dialog_header_settings', async ({ page }) => {
	...
	await expect(page).toHaveScreenshot('03-hide_dialog_header_settings.png');
...
test('Option: hide_dialog_header_overflow', async ({ page }) => {
	...
	await expect(page).toHaveScreenshot('04-hide_dialog_header_overflow.png');
...
test('Option: hide_dialog_header_action_items', async ({ page }) => {
	...
	await expect(page.locator(DIALOGS_SELECTORS.SETTINGS_BUTTON)).toBeHidden();
	await expect(page.locator(DIALOGS_SELECTORS.OVERFLOW_BUTTON)).toBeHidden();
	await expect(page).toHaveScreenshot('05-hide_dialog_header_action_items.png');
...
test('Option: hide_dialog_history', async ({ page }) => {
	...
	await expect(page).toHaveScreenshot('06-hide_dialog_history.png');
...
test('Option: hide_dialog_logbook', async ({ page }) => {
	...
	await expect(page).toHaveScreenshot('07-hide_dialog_logbook.png');
